...
console.log(meuMap);
var nome = meuMap.get("nome"); //Itens que selecionar 
...
var array = ['Maykon Wender', 'Diogo Resende', 'Luidy Bernardo', 'Ester Cristina', 'Maykon Wender'];
var arrayComoSet = new Set([].concat(array)); // Transformar array em set para tirar duplicatas
